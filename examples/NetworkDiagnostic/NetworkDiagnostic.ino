...
// IMPORTANTE: Não esqueça do "https://" no início!
...
void setup() {
  ...
  if (!urlStr.startsWith("http://") && !urlStr.startsWith("https://")) {
    ...
    Serial.println("   Exemplo correto: https://<sua-instancia>.wpiot.com.br");
    while(1) delay(1000);
  } else {
  ...
  if (httpCode > 0) {
    ...
    if (httpCode == -1) {
      ...
      Serial.println("   - Verifique se a URL da API está correta");
    }
  }
  ...
  // ========== TESTE 5: Conexão com a API WhatsApp ==========
  Serial.println("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  Serial.println("TESTE 5: Conexão via biblioteca WhatsAppESP32");
  Serial.println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");

  whatsapp.begin();

  if (whatsapp.isConnected()) {
    Serial.println("✅ Instância WhatsApp conectada!");
    Serial.print("   Telefone: ");
    Serial.println(whatsapp.getPhoneNumber());
    Serial.print("   Mensagens na fila: ");
    Serial.println(whatsapp.getQueueSize());
  } else {
    Serial.println("❌ Instância NÃO conectada!");
    Serial.println("   Verifique:");
    Serial.println("   - API Key está correta?");
    Serial.println("   - Instance Key está correta?");
    Serial.println("   - QR Code foi escaneado?");
  }
